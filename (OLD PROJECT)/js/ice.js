...
let snowStorm = function (g, f) {
  ...
  this.vMaxY = 4;
  this.zIndex = 0;
  var a = this, q, m = navigator.userAgent.match(/msie/i), E = navigator.userAgent.match(/msie 6/i),
    D = navigator.userAgent.match(/mobile|opera m(ob|in)/i), r = m && "BackCompat" === f.compatMode || E, h = null,
    n = null, l = null, p = null, s = null, z = null, A = null, v = 1, t = !1, w = !1,
    u;
  a:{
    try {
...
// Iceland
function snowflakeChange(){
  // Navigation Buttons


  // HTML Background Image:
  // let bgImage = document.getElementById("background2");
  //     bgImage.className = "fade-in";
  //     bgImage.src = "img/icelandbg.png";

  // Main Banner:
  let oldImg = document.getElementById("mainbannerid");
  oldImg.className = "fade-in";
  oldImg.src = "img/iceland.png";

  // Background Image:
  document.body.style.backgroundImage = "url('img/icelandbg3.png')";


  // Zelda Links:
  let zeldaLinks = document.getElementById("zelda-links-id");
  zeldaLinks.className = "zelda-links-class";
  // Game Ideas:
  let gameIdeas = document.getElementById("game-ideas-bar-id");
  gameIdeas.className = "game-ideas-iceland";


  // Search Button
  let searchButton = document.getElementById("search-id");
  searchButton.className = "search-submit-iceland";


  // Music:
  let audio = new Audio ("mp3/ice.mp3");
  audio.volume = 0.2;
  audio.play();
